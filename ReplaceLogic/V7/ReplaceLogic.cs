...
namespace ReplaceLogic.V7
{
    public static class ReplaceLogic
    {
        ...
        public static unsafe void ReplaceFile(StreamReader s, StreamWriter d, FastTreeNode[] tree, string[] strs, int max_len)
        {
            var n = 0;
            var tsl = new int[strs.Length];
            var tsi = new int[strs.Length];
